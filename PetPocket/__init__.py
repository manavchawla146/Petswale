...
def create_app(config_class=Config):
    ...
    app.config['RAZORPAY_KEY_ID'] = 'rzp_live_RGkEP4XjZZVrxv'
    app.config['RAZORPAY_KEY_SECRET'] = 'TWTYAAosnyLJvhGZtSZ24pOz'
    
    # Replace with valid credentials from Google Cloud Console
    app.config['GOOGLE_CLIENT_ID'] = '1047039162052-7e0fgrt2prvkcl2ta0ojao471ifs0c01.apps.googleusercontent.com'
